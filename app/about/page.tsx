            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Мы стремимся сделать процесс благотворительности простым, прозрачным и эффективным. Используя современные технологии, мы помогаем людям находить проекты, которые действительно важны для них, и быть уверенными, что их вклад используется по назначению.
                </p>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  Мы обеспечиваем полную прозрачность всех операций, чтобы вы точно знали, куда идут ваши средства.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Мы тщательно проверяем каждый проект, чтобы гарантировать его надежность и эффективность.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-4">Измеримые результаты</h3>
                <p className="text-gray-600">
                  Мы фокусируемся на проектах с конкретными, измеримыми результатами, чтобы вы видели реальное влияние.
                </p>
              </motion.div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Наш AI-ассистент анализирует ваши предпочтения через простые вопросы, чтобы определить, что вам важно: помощь людям, животным или природе.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  После анализа интересов, AI предоставляет список подходящих проектов, которые прошли тщательную проверку и направлены на решение конкретных проблем с измеримыми результатами.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Каждое пожертвование записывается в блокчейн, что позволяет вам отслеживать, как используются ваши средства, обеспечивая полную прозрачность.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Выберите проект, который вас вдохновляет, и сделайте пожертвование всего в несколько кликов через удобную систему оплаты.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-3">Результат, который вы видите</h3>
                <p className="text-gray-600 text-sm">
                  После пожертвования вы получаете доступ к данным о том, как используются ваши средства, что позволяет отслеживать прогресс проекта и видеть влияние вашего вклада.
                </p>
              </motion.div>
            </div>
          </div>
              ...
              <div className="relative p-12 md:p-16">
                ...
                <div className="relative z-10">
                  <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                    Узнайте, как легко вы можете помочь
                  </h2>
                  <p className="text-white/90 text-lg mb-8 max-w-2xl">
                    Ответьте на несколько вопросов и выберите проект, которому хотите помочь.
                  </p>
