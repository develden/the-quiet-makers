      ...
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <Link 
                      href="/quiz" 
                      className="inline-block py-4 px-8 bg-gradient-to-r from-primary-600 to-secondary-600 hover:from-primary-700 hover:to-secondary-700 text-white font-bold rounded-xl shadow-md hover:shadow-lg transition-all"
                    >
                      Пройти тест
                    </Link>
                  </motion.div>
                  ...
                  >
                    <Link 
                      href="/projects" 
                      className="inline-block py-4 px-8 bg-white text-gray-700 font-bold rounded-xl border border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm hover:shadow transition-all"
                    >
                      Смотреть проекты
                    </Link>
                  </motion.div>
              ...
              >
                ...
                <div className="absolute -bottom-10 right-6 bg-white rounded-xl shadow-lg p-4 max-w-xs">
                  <div className="flex items-center gap-3">
                    <div className="bg-green-50 p-3 rounded-full">
                      <FaRegCheckCircle className="text-green-600 text-xl" />
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Уже помогли</p>
                      <p className="font-bold text-gray-800">12,458 человек</p>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Выберите направление помощи</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Link href="/projects?categories=people" className="block">
                  ...
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">Помощь людям</h3>
                    </div>
              ...
              >
                <Link href="/projects?categories=animals" className="block">
                  ...
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      <div className="bg-white rounded-full p-3 mr-4 shadow-sm">
                        <FaPaw className="text-amber-600 text-xl" />
                      </div>
                      <h3 className="text-xl font-bold text-gray-800">Помощь животным</h3>
                    </div>
                    <p className="text-gray-600 mb-6">
              ...
              <motion.div 
                ...
                whileHover={{ y: -5, transition: { duration: 0.2 } }}
              >
                <Link href="/projects?categories=nature" className="block">
                  <div className="relative h-48 overflow-hidden">
                    <Image
                      src="https://placehold.co/800x600/10b981/FFFFFF?text=Помощь+природе"
                      alt="Помощь природе"
                      fill
                      className="object-cover transition-transform duration-500 group-hover:scale-105"
                    />
                  ...
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">Помощь природе</h3>
                    </div>
                    <p className="text-gray-600 mb-6">
                      Поддержите экологические проекты, направленные на сохранение природы, борьбу с загрязнением и защиту окружающей среды.
                    </p>
        ...
        <section className="py-20 bg-gradient-to-b from-white to-gray-50">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Как это работает</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-4">Пройдите тест</h3>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-4">Выберите проект</h3>
                <p className="text-gray-600">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-4">Сделайте вклад</h3>
                <p className="text-gray-600">
            ...
            <div className="text-center mt-12">
              ...
              >
                <Link 
                  href="/about" 
                  className="inline-flex items-center py-4 px-8 bg-white text-gray-700 font-bold rounded-xl border border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm hover:shadow transition-all"
                >
                  Узнать больше
                  <FaArrowRight className="ml-2" />
                </Link>
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    >
                      <Link 
                        href="/quiz" 
                        className="inline-block py-4 px-8 bg-white text-primary-600 font-bold rounded-xl shadow-md hover:shadow-lg transition-all"
                      >
                        Пройти тест
                      </Link>
                    </motion.div>
                    ...
                    >
                      <Link 
                        href="/projects" 
                        className="inline-block py-4 px-8 bg-white/10 text-white font-bold rounded-xl border border-white/30 hover:bg-white/20 transition-all"
                      >
